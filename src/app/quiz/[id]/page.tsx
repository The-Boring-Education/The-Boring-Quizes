...
function QuizContent() {
    ...
    useEffect(() => { loadQuiz() }, [quizId, loadQuiz])
    useEffect(() => { if (gameState === "playing") setQuestionStartTime(Date.now()) }, [currentQuestionIndex, gameState])
    ...
    const completeQuiz = async () => {
        ...
        try {
            ...
            const submission = { userId: validUserId, answers, totalTimeSpent }
                            ...
                            <Card className='shadow-lg'>
                                <CardContent className='p-12 text-center'>
                                    ...
                                    <div className='space-y-4'>
                                        <Button onClick={restartQuiz} className='w-full bg-indigo-600 hover:bg-indigo-700' size='lg'>Take Quiz Again</Button>
                                        <Button variant='outline' onClick={() => router.push("/dashboard")} className='w-full border-indigo-600 text-indigo-600 hover:bg-indigo-50' size='lg'>Back to Dashboard</Button>
                                        <Button variant='ghost' onClick={() => router.push("/performance")} className='w-full text-indigo-600 hover:bg-indigo-50' size='lg'>View Performance</Button>
                                    </div>
                                </CardContent>
                            </Card>
                        </div>
    ...
    if (!quiz || gameState !== "playing") return null
            ...
            <div className='min-h-screen bg-gray-50'>
                <div className='container mx-auto px-4 py-8'>
                    <div className='max-w-4xl mx-auto mb-8 text-center'>
                        ...
                        <p className='text-lg text-gray-600'>Question {currentQuestionIndex + 1} of {quiz.questions.length}</p>
                        <div className='mb-8'>
                        ...
                        <Card className='shadow-lg'>
                            ...
                            <CardContent className='bg-white p-8 space-y-6'>
                                ...
                                <div className='flex justify-end pt-6'>
                                    {!showExplanation ? (
                                        <Button onClick={nextQuestion} disabled={!hasSelectedAnswer} className='bg-indigo-600 hover:bg-indigo-700 text-white px-8 py-3 text-lg' size='lg'>
                                            {hasSelectedAnswer ? "Submit Answer" : "Select an answer"}
                                        </Button>
                                    ) : (
                                        <Button onClick={nextQuestion} className='bg-indigo-600 hover:bg-indigo-700 text-white px-8 py-3 text-lg' size='lg'>
